...
namespace Asteroids.Menu
{
    public static class MainMenu
    {
        ...
        public static void Load(Form form)
        {
            ...
            _university = new BaseText("GeekBrains", new Point(Width / 2 - 15, 0), new Point(0, 10), new Size(40, 40));
            _name = new Name("Дмитрий", new Point(0, Height / 2), new Point(10, 0), new Size(20, 20));
